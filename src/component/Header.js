      ...
      <header>
        ...
        >
          ...
          <li>
            <ul className="social">
              <li>
                <a href="#c" className="icons-sm fb-ic">
                  <i className="fa fa-facebook"> </i>
                </a>
              </li>
              <li>
                <a href="#c" className="icons-sm pin-ic">
                  <i className="fa fa-pinterest"> </i>
                </a>
              </li>
              <li>
                <a href="#c" className="icons-sm gplus-ic">
                  <i className="fa fa-google-plus"> </i>
                </a>
              </li>
              <li>
                <a href="#c" className="icons-sm tw-ic">
        ...
        <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
          <div className="float-left">
            <a href="#c" data-activates="slide-out" className="button-collapse">
          ...
          <ul className="nav navbar-nav nav-flex-icons ml-auto">
            <li className="nav-item dropdown">
              <a
                href="#c"
                className="nav-link dropdown-togg le waves-effect waves-light"
                id="dropdownMenu1"
              ...
              >
                <a href="#c" className="dropdown-item waves-effect waves-light">
                  Register
                </a>
                <a href="#c" className="dropdown-item waves-effect waves-light">
                  Login
